...
class ProductController extends Controller
{
    ...
    public function invoice(Request $request){
        ...
        $data =['total'=>$invoice->total,'branch'=>$invoice->branch,'receipt_no'=>$invoice->receipt_no,'printed_by'=>$invoice->printed_by,'created_at'=>date('M d,Y',strtotime($invoice->created_at)),'products'=>$products,'view'=>$request->view];
        if($invoice->type == 1){
